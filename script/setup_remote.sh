...
ssh root@$1 "cd $RPATH/cloud-morph; go build server.go; supervisord | true; service supervisor stop; service supervisor start; supervisorctl reread; supervisorctl restart server" 
