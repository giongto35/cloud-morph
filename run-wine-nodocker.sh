...
x86_64-w64-mingw32-g++ ./winvm/syncinput.cpp -o ~/.wine/drive_c/syncinput.exe -lws2_32 -static-libgcc -static-libstdc++
...
wine C:\\syncinput.exe $3 $4 < /dev/null > /dev/null 2>&1 & 
cd $1
